 ...
 * @author Chinh
 */
public class CIDPair implements Comparable, Serializable{
    public String id ;
    ...
    public CIDPair(Word r, Word a1, Word a2) {
        rel = r;
        arg1 = a1;
        arg2 = a2;
    }

    public CIDPair(String id, Word a1, Word a2,String type, boolean cid) {
        this.id =id ;
        arg1 = a1;
        arg2 = a2;
        this.type = type ;
   ...
   @Override
    ...
    public String toString() {
        return arg1.name+"-"+arg1.type+" "+arg2.name+"-"+arg2.type+" "+cid+" "+type ;
    }
}
